        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              <a href="mailto:avi620nash@gmail.com" className="group flex items-center gap-6 p-5 rounded-2xl bg-slate-900/50 border border-slate-700/50 hover:bg-slate-800/80 hover:border-cyan-500/50 transition-all">
                <div className="w-14 h-14 bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
              ...
              <a href="https://github.com/avi735" className="group flex items-center gap-6 p-5 rounded-2xl bg-slate-900/50 border border-slate-700/50 hover:bg-slate-800/80 hover:border-violet-500/50 transition-all" target="_blank" rel="noopener noreferrer">
                <div className="w-14 h-14 bg-violet-500/10 text-violet-400 border border-violet-500/20 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                ...
                <div>
                  ...
                  <div className="text-lg text-slate-200 font-semibold group-hover:text-violet-400 transition-colors">github.com/avi735</div>
                </div>
              </a>
          ...
          >
            <form id="contact-form" noValidate onSubmit={handleSubmit} className="flex flex-col gap-6">
              ...
              <button type="submit" disabled={loading} className="w-full inline-flex items-center justify-center gap-2 px-6 py-4 mt-2 rounded-xl bg-gradient-to-r from-cyan-400 to-violet-500 text-slate-950 font-bold hover:shadow-[0_0_25px_rgba(34,211,238,0.4)] disabled:opacity-70 disabled:cursor-not-allowed transition-all">
